...
function getKeyword(key) { 
   var key = document.getElementById("playfair-key").value;
   
   return document.getElementById("playfair-key").value;
  
}

function getplayfairmessage() {
  return document.getElementById("playfairmessage").value;
}
...
function cipher() {
  var keyresult = playfair();
  var res = [];
  var error = 'Warning!!! String is empty';
  var str = getplayfairmessage();
  if(str === '') {
